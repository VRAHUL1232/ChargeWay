      ...
      <header className="bg-white p-4 shadow-sm">
        <div className="container mx-auto flex justify-between items-center">
          <div className="flex items-center">
            <h1 className={`text-xl sm:text-4xl font-bold text-green-500`}>
              <span>ChargeWay</span>
            </h1>
          </div>
                ...
                <div className="bg-white rounded-lg overflow-hidden shadow-lg flex flex-col w-full">
                  ...
                  <div className="p-6 flex flex-col flex-grow">
                    <div>
                      ...
                      <Header4 style={`text-gray-600 mb-4`}>
                        As electric vehicle (EV) technology matures, real-world stories are increasingly challenging long-held apprehensions about battery life and long-distance dependability. A striking example has emerged from South Korea, where a Hyundai Ioniq 5 has clocked an extraordinary 5.8 lakh kilometres.
                      </Header4>
                    </div>
                    <div className="mt-auto">
                      <a
                ...
                <div className="bg-white rounded-lg overflow-hidden shadow-lg flex flex-col w-full">
                  ...
                  <div className="p-6 flex flex-col flex-grow">
                    <div>
                      ...
                      <Header4 style={`text-gray-600 mb-4`}>
                        Increasing emphasis on rooftop solar energy generation makes EVs fully green from well to wheel as they can be convenient charged from the energy produced without any use of fossil fuels while delivering the added benefits of the zero carbon emission. This further lowers the total cost of ownership of EVs.
                      </Header4>
                    </div>
                    <div className="mt-auto">
                      <a
        ...
        <div className="w-full h-full container mx-auto flex flex-wrap px-6 gap-4">
            ...
            <div className="w-full flex flex-row  justify-center sm:justify-end gap-4">
              ...
              <div className="w-full flex flex-row justify-center">
                <Header4 style={`text-gray-400`}>&copy;2023 ChargeWay all rights reserved</Header4>
              </div>
        </div>
      </section>
    </div>
